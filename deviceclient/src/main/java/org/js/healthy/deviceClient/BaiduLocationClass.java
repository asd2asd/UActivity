...
/**
 * Created by jose on 2017/10/19.
 */

public class BaiduLocationClass {

    private Context context;

    private BaiduLocationEvent event;

    public BaiduLocationClass(Context context,BaiduLocationEvent event)
    {
    ...
    public void onCreate()
    {
        ...
        mLocationClient = new LocationClient(((Activity)context).getApplication());
    ...
    public void logMsg(double latitude,double longitude,String locationInfo) {
        if(event!=null)
            event.OnReceiveLocationInfo(latitude,longitude,locationInfo);
    }
    ...
    private BDLocationListener mListener = new BDLocationListener() {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            logMsg(location.getLatitude(),location.getLongitude(),sb.toString());
        }
    ...
    public interface BaiduLocationEvent
    {
        void OnReceiveLocationInfo(double lan,double lon,String info);
