...
/**
 * Created by justs_000 on 2014/12/31.
 */
...
public class PopMenu {
    ...
    public PopMenu(Context context) {
        ...
        //设置 listview
        listView = (ListView)view.findViewById(R.id.popupMenulistView);
    ...
    private final class PopAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.groupItem = (TextView) convertView.findViewById(R.id.popupMenuItemTextView);
